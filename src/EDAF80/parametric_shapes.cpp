...
bonobo::mesh_data parametric_shapes::createCylinder(float const radius, float const length, unsigned int const radial_split_count, unsigned int const length_split_count) {
    ...
    auto const total_vertices = radial_vertex_count * length_vertex_count;
