...
bonobo::loadTextureCubeMap(std::string const& posx, std::string const& negx,
    ...
    auto data1 = getTextureData(posx, width, height, false);
    if (data1.empty()) {
        glDeleteTextures(1, &texture);
        return 0u;
    }
    glTexImage2D(GL_TEXTURE_CUBE_MAP_POSITIVE_X,
                 ...
                 GL_RGBA,
                 GL_UNSIGNED_BYTE,
                 reinterpret_cast<GLvoid const*>(data1.data()));

    auto data2 = getTextureData(negy, width, height, false);
    if (data2.empty()) {
        glDeleteTextures(1, &texture);
        return 0u;
    }
    glTexImage2D(GL_TEXTURE_CUBE_MAP_NEGATIVE_Y,
                 ...
                 GL_RGBA,
                 GL_UNSIGNED_BYTE,
                 reinterpret_cast<GLvoid const*>(data2.data()));

    auto data3 = getTextureData(posy, width, height, false);
    if (data3.empty()) {
        glDeleteTextures(1, &texture);
        return 0u;
    }
    glTexImage2D(GL_TEXTURE_CUBE_MAP_POSITIVE_Y,
                 ...
                 GL_RGBA,
                 GL_UNSIGNED_BYTE,
                 reinterpret_cast<GLvoid const*>(data3.data()));

    auto data4 = getTextureData(negz, width, height, false);
    if (data4.empty()) {
        glDeleteTextures(1, &texture);
        return 0u;
    }
    glTexImage2D(GL_TEXTURE_CUBE_MAP_NEGATIVE_Z,
                 ...
                 GL_RGBA,
                 GL_UNSIGNED_BYTE,
                 reinterpret_cast<GLvoid const*>(data4.data()));

    auto data5 = getTextureData(posz, width, height, false);
    if (data5.empty()) {
        glDeleteTextures(1, &texture);
        return 0u;
    }
    glTexImage2D(GL_TEXTURE_CUBE_MAP_POSITIVE_Z,
                 ...
                 GL_RGBA,
                 GL_UNSIGNED_BYTE,
                 reinterpret_cast<GLvoid const*>(data5.data()));
